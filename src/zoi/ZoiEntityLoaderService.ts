...
//         console.log("[zoi] Loaded templates:", templates);
...
//                 try {
//                     console.log(`[zoi] Processing template: ${template.name}`);
...
//                         entitiesFromTemplate.forEach(entity => {
//                             console.log(`[zoi] ✓ Generated entity: ${entity.name}`);
...
//         console.log(`[zoi] Searching for entity: ${name}`, entities[0].name);
...
//     /**
//      * Debug method to check what entities will be generated
//      */
...
//                 console.log(`Schema:`, JSON.stringify(template.schema, null, 2));
//             }
