...
//         // Workspace relationship if scoped (MAKE IT NULLABLE FOR SIGNATURES)
//         if (schema.workspace_scoped) {
//             ManyToOne(() => Workspace, { 
//                 nullable: true  // 👈 CRITICAL: Make nullable for signature tables
//             })(entityClass.prototype, 'workspace');
//             JoinColumn({ name: 'workspace_id' })(entityClass.prototype, 'workspace');
//         }

//         // Main entity relationship (ALSO NULLABLE)
//         const mainEntity = this.generatedEntities.get(schema.type);
//         if (mainEntity) {
//             ManyToOne(() => mainEntity, {
//                 nullable: true  // 👈 CRITICAL: Signatures might not have parent initially
//             })(entityClass.prototype, schema.type.toLowerCase());
//             JoinColumn({ 
//                 name: `${schema.type.toLowerCase()}_id` 
//             })(entityClass.prototype, schema.type.toLowerCase());
//         }

//         // User relationship (NULLABLE for pending signatures)
//         ManyToOne(() => User, { 
//             nullable: true  // 👈 CRITICAL: User might not be assigned yet
//         })(entityClass.prototype, 'user');
...
//     private static applyWorkflowEntityDecoratorsLOL(
//         entityClass: Function,
//         schema: EntitySchema,
//         suffix: string,
//         fields: Record<string, FieldDefinition>
